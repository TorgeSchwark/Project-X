...
from flipper.flipper_main import *
...
class FrameGame:
    def __init__(self, size):
        ...
        self.current_game_name = "frame_game"
    ...
    def setup_frame(self):
        ...
        #define Flipper Button and funcionality
        flipper_game_name = "Flipper of Physics"
        self.games_buttons.add_button("scrollable", flipper_game_name)
        self.games_buttons.set_button_frame_image("./src/Images/game_frame_gold.png","scrollable", 0)
        self.games[flipper_game_name] = Flipper()
        function_parameters = [flipper_game_name]
        self.games_buttons.set_function(self.change_game, function_parameters, "scrollable", 0)
